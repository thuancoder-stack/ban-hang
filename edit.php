...
$product = null;
$stmt = $con->prepare("SELECT id, name, price, image FROM products WHERE id = ? AND user_id = ?");
if ($stmt) {
...
if (isset($_GET['status'])) {
    if ($_GET['status'] === "empty_name") {
        $statusMessage = "Vui long nhap ten san pham.";
    } elseif ($_GET['status'] === "update_failed") {
        $statusMessage = "Cap nhat that bai.";
    } elseif ($_GET['status'] === "upload_failed") {
        $statusMessage = "Upload hinh anh that bai.";
    }
}
?>
<!DOCTYPE html>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <div class="table-responsive cart_info" style="padding:20px; background:#fff; border:1px solid #f0f0f0;">
                    ...
                    <form action="update-product.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            ?>
                            <img src="<?= htmlspecialchars($imagePath); ?>" alt="<?= htmlspecialchars($product['name']); ?>" class="product-preview">
                        </div>

                        <div class="form-group">
                            <label>New Image</label>
                            <input type="file" name="image" class="form-control">
                            <p style="margin-top:5px; color:#777;">Khong chon anh moi thi giu anh cu.</p>
                        </div>
                        ...
                        <div style="margin-top:20px;">
                            ...
                            <a href="my-product.php" class="btn btn-default">Back</a>
                        </div>
                    </form>
                </div>
            </div>
